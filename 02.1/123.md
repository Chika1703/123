...
- **Скриншот панели управления Timeweb Cloud с созданными серверами:**  
  ![Панель управления](./photo_1_2025-04-04_03-10-45.jpg)

- **Скриншот консоли с выводом внешнего IP (например, команда `curl ifconfig.me`):**  
  ![Консоль: внешний IP](./photo_2_2025-04-04_03-10-45.jpg)

- **Скриншот выполнения команды `terraform output` с информацией о серверах:**  
  ![Вывод terraform output](./photo_3_2025-04-04_03-10-45.jpg)
...
*Примечание:* Дополнительные задания (со звёздочкой*) не выполнялись.